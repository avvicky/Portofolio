        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-gray-200 ">
              ...
              solving problems, to optimize web applications.
            </p>
          </div>
          <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600">
            ...
            <a href="https://twitter.com/Vignesh_armugam" target="_blank">
              <AiFillTwitterCircle />
            </a>
          </div>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200 ">
              Since the beginning of my journey as a web dev i have build
              projects with following tech-stack
            </p>
          </div>
          <div className="lg:flex  justify-between gap-5 dark:text-gray-200 ">
            <div className="text-center object-center shadow-lg dark:shadow-gray-600 p-10 rounded-xl ">
              <Image
                className="cardImage object-center"
                src={design}
                width={100}
                height={100}
              />
        ...
        <section>
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap ">
            <div className="basis-1/3 flex-1">
              <div className="shadow-lg dark:shadow-gray-600 rounded-lg">
                <a
                  href="https://github.com/avvicky/amazon-clone"
                  target="_blank"
                >
                  <Image
                ...
                <h4 className="text-gray-800 py-1 px-5 dark:text-gray-200">
                  Amazon Clone
                </h4>
              </div>
            </div>
            <div className="basis-1/3 flex-1 ">
              <div className="shadow-lg dark:shadow-gray-600 rounded-lg">
                <a href="https://github.com/avvicky/gym-app" target="_blank">
                  <Image
                    className="rounded-lg object-cover"
                    loading="lazy"
                    alt="Gym-app"
            ...
            <div className="basis-1/3 flex-1">
              <div className="shadow-lg dark:shadow-gray-600 rounded-lg">
                <a href="https://github.com/avvicky/Blog" target="_blank">
                  <Image
                    className="rounded-lg object-cover"
                    loading="lazy"
                    alt="Blog"
            ...
            <div className="basis-1/3 flex-1">
              <div className="shadow-lg dark:shadow-gray-600 rounded-lg">
                <a
                  href="https://github.com/avvicky/random-quote"
                  target="_blank"
                >
                  <Image
                    className="rounded-lg object-cover"
            ...
            <div className="basis-1/3 flex-1">
              <div className="shadow-lg dark:shadow-gray-600 rounded-lg">
                <a href="https://github.com/avvicky/Todo-List" target="_blank">
                  <Image
                    className="rounded-lg object-cover"
                    alt="Todo-List"
                    loading="lazy"
            ...
            <div className="basis-1/3 flex-1">
              <div className="shadow-lg dark:shadow-gray-600 rounded-lg">
                <a href="https://github.com/avvicky/OAuth" target="_blank">
                  <Image
                    className="rounded-lg object-cover"
                    alt="OAuth"
                    loading="lazy"
